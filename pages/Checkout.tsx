...
import { ShoppingBag, Loader2, Trash2, ArrowLeft, Truck, Home } from 'lucide-react';
...
const Checkout = () => {
  ...
  return (
    <main className="p-5 md:px-[5%] grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
      ...
      <aside className="bg-primary text-white p-8 rounded-[20px] h-fit sticky top-24 shadow-xl shadow-primary/20">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-bold">{t('summary')}</h3>
          <button 
            type="button"
            onClick={handleClearBag}
            className="text-white/70 underline hover:text-white text-sm disabled:opacity-50"
